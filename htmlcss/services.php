...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../htmlcss/css/services.css">
...
<div class="maindivContainer">
    <div class="div1">
        <div class="image-container">
            ...
            <div class="label"><h2>Free Local Delivery</h2></div>
        </div>
        <div class="image-container">
            <img src="./images/reviews2.jpg" alt="reviews">
            <div class="label"><h2>Rewards for Reviews</h2></div>
        </div>
