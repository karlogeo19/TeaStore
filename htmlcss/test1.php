...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../htmlcss/css/test1.css">
...
<body>
    ...
    <div class="maindivContainer">
        <div class="div1">
            <h1 class="div1logo">Tea Business E-Commerce Store</h1>
            <h3>Discover the Delight in Every Bite and Every Brew.</h3>
            <button class="explore-button" onclick="window.location.href='../htmlcss/product.html'">Explore Our Products</button>
        </div>
